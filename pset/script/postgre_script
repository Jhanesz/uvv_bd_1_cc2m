...
CREATE USER jhanesz WITH PASSWORD '123' CREATEDB;

ALTER USER jhanesz PASSWORD 123;
COMMIT;
...
\c uvv
--Criação do schema elmasri e autorização para o usuário criado.
CREATE SCHEMA elmasri  AUTHORIZATION jhanesz;

--Fazendo o Schema elmasri como padrão.
...
--introdução dos dados na tabela funcionário
...
--introdução dos dados na tabela departamento
...
--introdução dos dados na tabela localizacoes_departamento		   
...
--introdução dos dados na tabela projeto
...
--introdução dos dados na tabela dependente
...
--introdução dos dados na tabela trabalha em
